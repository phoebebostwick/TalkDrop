...
public class RecordingController_Master : MonoBehaviour {
	...
	public void saveRecording() {
		...
		if(ShapeInstance) {
			...
			playPauseMaterials = ShapeInstance.transform.Find ("ColorBubble").GetComponent<MeshRenderer> ().materials;
			playPauseMaterials [0] = playCore;
			ShapeInstance.transform.Find ("ColorBubble").GetComponent<MeshRenderer> ().materials = playPauseMaterials;
		}
	}
